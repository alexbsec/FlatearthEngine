...
const char *VkResultToString(VkResult result, bool getExtended) {
  // From:
  ...
  case VK_NOT_READY:
    return !getExtended ? "VK_NOT_READY"
  ...
  case VK_SUBOPTIMAL_KHR:
    return !getExtended ? "VK_SUBOPTIMAL_KHR"
                        : "VK_SUBOPTIMAL_KHR A swapchain no longer matches the "
                          "surface properties exactly, but can still be used "
  ...
  case VK_THREAD_DONE_KHR:
    return !getExtended
               ? "VK_THREAD_DONE_KHR"
               : "VK_THREAD_DONE_KHR A deferred operation is not complete but "
                 "there is no work remaining to assign to additional threads.";
  case VK_OPERATION_DEFERRED_KHR:
    return !getExtended
               ? "VK_OPERATION_DEFERRED_KHR"
               : "VK_OPERATION_DEFERRED_KHR A deferred operation was requested "
                 "and at least some of the work was deferred.";
  case VK_OPERATION_NOT_DEFERRED_KHR:
    return !getExtended ? "VK_OPERATION_NOT_DEFERRED_KHR"
  ...
  case VK_ERROR_INITIALIZATION_FAILED:
    return !getExtended
               ...
               : "VK_ERROR_INITIALIZATION_FAILED Initialization of an object "
                 "could not be completed for implementation-specific reasons.";
  case VK_ERROR_DEVICE_LOST:
    return !getExtended ? "VK_ERROR_DEVICE_LOST"
                        : "VK_ERROR_DEVICE_LOST The logical or physical device "
                          "has been lost. See Lost Device";
  ...
  case VK_ERROR_FEATURE_NOT_PRESENT:
    return !getExtended ? "VK_ERROR_FEATURE_NOT_PRESENT"
                        : "VK_ERROR_FEATURE_NOT_PRESENT A requested feature is "
                          "not supported.";
  case VK_ERROR_INCOMPATIBLE_DRIVER:
    return !getExtended
               ? "VK_ERROR_INCOMPATIBLE_DRIVER"
               : "VK_ERROR_INCOMPATIBLE_DRIVER The requested version of Vulkan "
  ...
  case VK_ERROR_TOO_MANY_OBJECTS:
    return !getExtended ? "VK_ERROR_TOO_MANY_OBJECTS"
                        : "VK_ERROR_TOO_MANY_OBJECTS Too many objects of the "
                          "type have already been created.";
  case VK_ERROR_FORMAT_NOT_SUPPORTED:
    return !getExtended ? "VK_ERROR_FORMAT_NOT_SUPPORTED"
                        : "VK_ERROR_FORMAT_NOT_SUPPORTED A requested format is "
                          "not supported on this device.";
  case VK_ERROR_FRAGMENTED_POOL:
    return !getExtended
               ? "VK_ERROR_FRAGMENTED_POOL"
               : "VK_ERROR_FRAGMENTED_POOL A pool allocation has failed due to "
                 "fragmentation of the pool’s memory. This must only be "
                 "returned if no attempt to allocate host or device memory was "
                 "made to accommodate the new allocation. This should be "
  ...
  case VK_ERROR_OUT_OF_DATE_KHR:
    return !getExtended
               ...
               : "VK_ERROR_OUT_OF_DATE_KHR A surface has changed in such a way "
                 "that it is no longer compatible with the swapchain, and "
                 "further presentation requests using the swapchain will fail. "
                 "Applications must query the new surface properties and "
                 "recreate their swapchain if they wish to continue presenting "
                 "to the surface.";
  case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
    return !getExtended
               ? "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR"
               : "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR The display used by a "
                 "swapchain does not use the same presentable image layout, or "
  ...
  case VK_ERROR_INVALID_EXTERNAL_HANDLE:
    return !getExtended ? "VK_ERROR_INVALID_EXTERNAL_HANDLE"
  ...
  case VK_ERROR_FRAGMENTATION:
    return !getExtended ? "VK_ERROR_FRAGMENTATION"
                        : "VK_ERROR_FRAGMENTATION A descriptor pool creation "
                          "has failed due to fragmentation.";
  ...
  //    return !getExtended ? "VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS"
  ...
  case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
    return !getExtended
               ...
               : "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT An operation on "
                 "a swapchain created with "
                 "VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT failed "
                 "as it did not have exlusive full-screen access. This may "
                 "occur due to implementation-dependent reasons, outside of "
                 "the application’s control.";
  case VK_ERROR_UNKNOWN:
    return !getExtended ? "VK_ERROR_UNKNOWN"
